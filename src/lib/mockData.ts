...
export const mockSmallGroups: SmallGroup[] = [
  ...
  { id: "sg_bukavu_isp", name: "ISP", siteId: "site_bukavu", leaderId: "user_coord_bukavu_jane" },
  { id: "sg_bukavu_uea", name: "UEA", siteId: "site_bukavu", leaderId: "user_coord_bukavu_jane" },
  { id: "sg_bukavu_isecof", name: "ISECOF", siteId: "site_bukavu", leaderId: "user_coord_bukavu_jane" },
  { id: "sg_bukavu_uob", name: "UOB", siteId: "site_bukavu", leaderId: "user_coord_bukavu_jane" },
  // Bunia
  { id: "sg_bunia_alumni", name: "ALUMNI", siteId: "site_bunia", leaderId: "user_leader_bunia_alumni_ben" },
  { id: "sg_bunia_unibu", name: "UNIBU", siteId: "site_bunia", leaderId: "user_coord_bunia_paul" }, 
  { id: "sg_bunia_unshalom", name: "UN.SHALOM", siteId: "site_bunia", leaderId: "user_coord_bunia_paul" }, 
  // Butembo
  { id: "sg_butembo_alumni", name: "ALUMNI", siteId: "site_butembo", leaderId: "user_leader_butembo_alumni_beth" },
  { id: "sg_butembo_uac", name: "UAC", siteId: "site_butembo", leaderId: "user_coord_butembo_peter" },
  { id: "sg_butembo_ucg", name: "UCG", siteId: "site_butembo", leaderId: "user_coord_butembo_peter" },
  { id: "sg_butembo_uor", name: "UOR", siteId: "site_butembo", leaderId: "user_coord_butembo_peter" },
  // Goma
  ...
  // Kalemie
  { id: "sg_kalemie_alumni", name: "ALUMNI", siteId: "site_kalemie", leaderId: "user_leader_kalemie_alumni_ken" },
  { id: "sg_kalemie_isp", name: "ISP", siteId: "site_kalemie", leaderId: "user_coord_kalemie_kevin" },
  { id: "sg_kalemie_istm", name: "ISTM", siteId: "site_kalemie", leaderId: "user_coord_kalemie_kevin" },
  { id: "sg_kalemie_isss", name: "ISSS", siteId: "site_kalemie", leaderId: "user_coord_kalemie_kevin" },
  { id: "sg_kalemie_unikal", name: "UNIKAL", siteId: "site_kalemie", leaderId: "user_coord_kalemie_kevin" },
  // Kinshasa
  { id: "sg_kinshasa_alumni", name: "ALUMNI", siteId: "site_kinshasa", leaderId: "user_leader_kinshasa_alumni_kate" },
  { id: "sg_kinshasa_unikin", name: "UNIKIN", siteId: "site_kinshasa", leaderId: "user_coord_kinshasa_karen" },
  { id: "sg_kinshasa_unimkin", name: "UNIM/Kin", siteId: "site_kinshasa", leaderId: "user_coord_kinshasa_karen" },
  // Kisangani
  { id: "sg_kisangani_alumni", name: "ALUMNI", siteId: "site_kisangani", leaderId: "user_leader_kisangani_alumni_kurt" },
  { id: "sg_kisangani_unikis", name: "UNIKIS", siteId: "site_kisangani", leaderId: "user_coord_kisangani_kim"},
  { id: "sg_kisangani_upc", name: "UPC", siteId: "site_kisangani", leaderId: "user_coord_kisangani_kim"},
  // Kolwezi
  { id: "sg_kolwezi_alumni", name: "ALUMNI", siteId: "site_kolwezi", leaderId: "user_leader_kolwezi_alumni_keira" },
  { id: "sg_kolwezi_unikol", name: "UNIKOL", siteId: "site_kolwezi", leaderId: "user_coord_kolwezi_kyle" },
  // Lubumbashi
  { id: "sg_lubumbashi_alumni", name: "ALUMNI", siteId: "site_lubumbashi", leaderId: "user_leader_lubumbashi_alumni_liam" },
  { id: "sg_lubumbashi_unilu", name: "UNILU", siteId: "site_lubumbashi", leaderId: "user_coord_lubumbashi_leo" },
  // Uvira
  { id: "sg_uvira_alumni", name: "ALUMNI", siteId: "site_uvira", leaderId: "user_leader_uvira_alumni_uma" },
  { id: "sg_uvira_isc", name: "ISC", siteId: "site_uvira", leaderId: "user_coord_uvira_ursula" },
  { id: "sg_uvira_isdr", name: "ISDR", siteId: "site_uvira", leaderId: "user_coord_uvira_ursula" },
  { id: "sg_uvira_isp", name: "ISP", siteId: "site_uvira", leaderId: "user_coord_uvira_ursula" },
  { id: "sg_uvira_istm", name: "ISTM", siteId: "site_uvira", leaderId: "user_coord_uvira_ursula" },
  { id: "sg_uvira_undt", name: "UNDT", siteId: "site_uvira", leaderId: "user_coord_uvira_ursula" },
];
